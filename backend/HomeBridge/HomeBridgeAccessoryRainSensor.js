//
// HomeBridgeAccessoryRainSensor.js
//
...
class HomeBridgeAccessoryRainSensor extends HomeBridgeAccessory {
  ...
  constructor(common, api, item, statNo) {
    ...
    this.AddStatusChange(service, 'rain', (service, stat) => {
      service.setCharacteristic(Characteristic.CurrentRelativeHumidity, parseFloat(stat.value));
    });
  }
}

module.exports = HomeBridgeAccessoryRainSensor;
