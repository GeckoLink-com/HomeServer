  ...
  _ExecSequence(codeComment) {
    ...
    do {
      ...
      switch (this._vue.sequence) {
        ...
        case 3:
        case 23:
          if(!this._vue.lowTemp[this._vue.mode] || (parseInt(this._vue.lowTemp[this._vue.mode]) === 0)) {
        ...
        case 6:
        case 26:
          if(!this._vue.highTemp[this._vue.mode] || (parseInt(this._vue.highTemp[this._vue.mode]) === 0)) {
